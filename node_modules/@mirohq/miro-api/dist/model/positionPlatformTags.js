...
exports.PositionPlatformTags = void 0;
/**
 * @internal
...
class PositionPlatformTags {
    constructor() {
         ...
         */
        this['origin'] = PositionPlatformTags.OriginEnum.Center;
        /**
...
exports.PositionPlatformTags = PositionPlatformTags;
/** @ignore */
PositionPlatformTags.discriminator = undefined;
/** @ignore */
PositionPlatformTags.attributeTypeMap = [
    {
        name: 'origin',
        baseName: 'origin',
...
(function (PositionPlatformTags) {
    PositionPlatformTags.OriginEnum = {
        Center: 'center',
    };
    PositionPlatformTags.RelativeToEnum = {
        CanvasCenter: 'canvas_center',
        ParentTopLeft: 'parent_top_left',
    };
})(PositionPlatformTags = exports.PositionPlatformTags || (exports.PositionPlatformTags = {}));
