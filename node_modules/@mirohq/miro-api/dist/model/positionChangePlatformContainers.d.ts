 ...
 */
export declare class PositionChangePlatformContainers {
    /**
     ...
     */
    'origin'?: string | typeof PositionChangePlatformContainers.OriginEnum[keyof typeof PositionChangePlatformContainers.OriginEnum];
    /**
...
export declare namespace PositionChangePlatformContainers {
    const OriginEnum: {
