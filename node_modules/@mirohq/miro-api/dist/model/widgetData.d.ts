...
export declare class WidgetData {
     ...
     */
    'shape'?: string | typeof WidgetData.ShapeEnum[keyof typeof WidgetData.ShapeEnum];
    /**
     ...
     */
    'format'?: string | typeof WidgetData.FormatEnum[keyof typeof WidgetData.FormatEnum];
    /**
     * Only free form frames are supported at the moment. Possible values: `freeform`, `heap`, `grid`, `rows`, `columns`
     */
    'type'?: string | typeof WidgetData.TypeEnum[keyof typeof WidgetData.TypeEnum];
    /** @ignore */
